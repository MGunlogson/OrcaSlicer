...
static std::vector<std::string> s_Preset_print_options {
    ...
    "minimum_sparse_infill_area", "filter_narrow_sparse_infill", "minimum_sparse_infill_width", "reduce_infill_retraction","internal_solid_infill_pattern","gap_fill_target",
     ...
     "magma_tube_width_mode", "magma_nozzle_outer_diameter", "magma_interior_width", "magma_window_height_mm", "magma_tube_height", "magma_stagger_period", "magma_tube_fill_factor", "magma_spiral_interlock", "magma_tube_solver_mode", "magma_solver_timeout",
