...
// Zone boundary: Toggle between Initial and Smoothed stages
void GCodeViewer::cycle_zone_boundary_stage()
{
    ZoneBoundaryStage next = (m_zone_shells.stage == ZoneBoundaryStage::Initial)
        ? ZoneBoundaryStage::Smoothed : ZoneBoundaryStage::Initial;
